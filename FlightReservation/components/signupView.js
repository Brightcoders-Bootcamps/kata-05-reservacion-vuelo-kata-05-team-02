            ...
            <View style={styles.containerPassword}>                
                ...
                <View style={styles.containerIconPassword}>
                    <Pressable onPress={changeSeePassword}>        
                        <Image  style={styles.iconSeePassword} source={require('../img/ojo-grey.png')} />
                    </Pressable>
                </View>
            </View>
            <Text style={styles.instruccionsPassword}>Use 8 or more characters with a mix of letters, numbers, and symbols</Text>            
        </View>
    )
}
    ...
    return (
        <View style={styles.containerForm}>            
            <View style={styles.checkboxContainer}>
                ...
                />
                <Text style={styles.labelCheckBox}>I agree to the Terms and Privacy Policy *</Text>
            </View>            
            ...
            <View style={styles.checkboxContainer}>
                <CheckBox
                    ...
                    tintColors={{ true: '#3E59F7', false: 'black' }}
                />
                <Text style={styles.labelCheckBox}>Subscribe for select products and updates</Text>
            </View>            
