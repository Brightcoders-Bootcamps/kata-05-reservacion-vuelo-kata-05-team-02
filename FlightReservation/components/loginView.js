...
function LoginView(props) {
  const {validEmail,setValidEmail,setIsLoginFormActive,validPassword, setValidPassword, isLoginFormActive, showObj, showModal, addFill, formObjectState, modalVisible, singedText, isIconCheck} = props;
